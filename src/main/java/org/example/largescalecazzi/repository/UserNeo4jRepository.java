...
public interface UserNeo4jRepository extends Neo4jRepository<UserNeo4j, String> {
    ...
    @Query("MATCH (me:User {userId: $userId})-[myPlay:PLAYS]->(commonGame:Game) " +
            ...
            "WITH me, commonGame ORDER BY rand() LIMIT 50 " +
    ...
    // A. Aggiungi Gioco alla libreria (Crea relazione PLAYS)
    ...
    // E. Rimuovi Amico (Cancellazione Relazione)
    ...
    // F. Rimuovi Gioco dalla Libreria (Cancellazione Relazione)
    ...
    // H. Controllo "Possiede questo gioco?"
